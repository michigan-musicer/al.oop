// For the tasks in this file, please see Rectangle.java as an example.

// Task 1: make Triangle inherit from Shape.
// Task 2: implement all functions that Triangle must inherit from the Shape interface.
